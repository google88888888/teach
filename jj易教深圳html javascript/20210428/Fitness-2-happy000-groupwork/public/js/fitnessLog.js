...
progress_button.addEventListener("click",progress_button_onclick)

window.addEventListener("load",reminder_load)
...
function submit_future_activity_onclick() {
  ...
  //这个date2是我转换好的，但是放到data这个object里好像就出问题
  //你们去oh可以问问为啥
  //const moonLanding = new Date(document.getElementById('fAct-date').value);
  //let date2 = moonLanding.getTime();
  //console.log(date2);
  ...
  //console.log(data);
  //const moonLanding = new Date(data.date);
...
function progress_button_onclick(){
  //open barachart;
}
